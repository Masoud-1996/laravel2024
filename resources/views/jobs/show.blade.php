<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <section class="md:col-span-3">
            ...
            <div class="container mx-auto p-4">
                ...
                @auth
                    ...
                    text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
                            Apply Now
                        </button>
                        <div x-show="open"
                ...
                @else
                    <p class="my-5 bg-gray-300 rounded-xl p-3">
                        <i class="fas fa-info-circle mr-3 text-yellow-600"></i> You must be logged in to apply this job
                    </p>
                @endauth
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            @guest
                <p class="mt-10 bg-gray-200 text-red-800 font-bold w-full py-2 px-4 rounded-full text-center">

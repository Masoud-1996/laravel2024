    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit"
                    class="w-full bg-green-500 hover:bg-green-700 text-white px-4 py-4 border rounded focus:outline-none">
                    Save
                </button>
            </form>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            @forelse ($jobs as $job)
                <div class="flex justify-between item-center border-b-2 border-gray-200 py-2">
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('jobs.edit', $job->id) }}"
                            class="bg-blue-500 text-white px-4 py-2 my-3 md:my-6 rounded text-sm">Edit</a>
                        <!-- Delete Form -->
                        <form method="POST" action="{{ route('jobs.destroy', $job->id) }}?from=dashboard"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="px-4 py-2 my-3 md:my-6 bg-red-500 hover:bg-red-600 text-white rounded text-sm">
                                Delete
                            </button>
                        </form>
                        <!-- End Delete Form -->
                ...
                <div class="mt-4 bg-gray-200 p-2">
                    <h4 class="text-lg font-semibold mt-2">Applicants</h4>
                        ...
                        <div class="py-2">
                            ...
                            <p class="text-gray-800 mt-2">
                                <a href="{{ asset('storage/' . $applicant->resume_path) }}"
                                    class="text-blue-500 font-medium hover:underline text-sm" download>
